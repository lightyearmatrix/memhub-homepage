      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <Link to="/">
              <SuperMemLogo className="h-10 w-auto opacity-60 hover:opacity-100 transition-opacity duration-150" />
            </Link>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-2 pt-4 border-t border-border">
            <a href="mailto:k@supermem.io" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-150">
              k@supermem.io
            </a>
